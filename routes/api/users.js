 ...
 */
 router.post('/register',  (req,res)=>{
	...
	const { name,password,retype_password,company,industry,hear,email,phone,track,coupon,username,address,card} = req.body
    /** Validations */
...
/**
 * DASHBOARD
 * PROTECTED : AUTHENTICATED MIDDLEWARE TO PROTECT ROUTE
 */
